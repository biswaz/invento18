...
ROOT_DIR = environ.Path(__file__) - 3  # (invento18/config/settings/base.py - 3 = invento18/)
APPS_DIR = ROOT_DIR.path('invento18')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'invento18.contrib.sites.migrations'
}
